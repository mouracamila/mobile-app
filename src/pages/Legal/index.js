  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={{ fontSize: 22 }}>Legal</Text>
      ...
      >
        ...
        <Text style={{ fontSize: 22, marginVertical: 20 }}>Abuso e spam </Text>
        <Text>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate
          minus nemo itaque quae repellat vitae voluptatibus atque numquam
          quisquam sit architecto dolores temporibus fuga sint perspiciatis, a
        ...
        <Text style={{ fontSize: 22, marginVertical: 20 }}>outra coisa </Text>
        <Text>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate
          minus nemo itaque quae repellat vitae voluptatibus atque numquam
          quisquam sit architecto dolores temporibus fuga sint perspiciatis, a
